    ...
    <main className="py-6 px-4 sm:p-6 md:py-10 md:px-8 dark:bg-slate-800">
      <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
        <div className="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
          ...
          <p className="text-sm leading-4 font-medium text-white sm:text-slate-300 dark:sm:text-slate-300">Entire house</p>
        </div>
        ...
        <dl className="mt-4 text-xs font-medium flex items-center row-start-2 sm:mt-1 sm:row-start-3 md:mt-2.5 lg:row-start-2">
          ...
          <dd className="text-indigo-600 flex items-center dark:text-indigo-400">
            ...
            <span>4.89 <span className="text-slate-200 font-normal">(128)</span></span>
          </dd>
