    ...
    <main className="py-6 px-4 sm:p-6 md:py-10 md:px-8 dark:bg-slate-800">
      <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
        <div className="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
          ...
          <p className="text-sm leading-4 font-medium text-white sm:text-black lg:text-black dark:sm:text-white dark:md:text-white dark:lg:text-white">Entire house</p>
        </div>
        <div className="grid gap-2 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-2 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0 self-start">
        ...
        <p className="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-300">
